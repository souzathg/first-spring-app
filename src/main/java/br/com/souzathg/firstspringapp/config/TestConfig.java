...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(Instant.parse("2022-11-27T17:00:00-03:00"), u1);
        Order o2 = new Order(Instant.parse("2022-11-27T16:00:00-03:00"), u2);
        Order o3 = new Order(Instant.parse("2022-11-27T18:00:00-03:00"), u1);
