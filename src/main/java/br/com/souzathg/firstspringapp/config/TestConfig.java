...
import br.com.souzathg.firstspringapp.entities.*;
...
import br.com.souzathg.firstspringapp.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(Instant.parse("2022-11-27T19:00:00-03:00"), o1);
        o1.setPayment(pay1);
